...
const swiperContainer = document.querySelector('.projects-swiper-wrapper');
// document.addEventListener('DOMContentLoaded', event => {
//   swiperContainer.innerHTML = createMarkup(images);
// });
const seeProjectRef = 'https://github.com/aitmil/hugs-for-bugs/';
    ...
    .map(
      ({
        ...
        <div class="project-section-dark-part">
          <picture class="project-section-img">
                  <source
